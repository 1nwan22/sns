		...
		<div class="write-box border rounded m-3">
			...
			<div class="d-flex justify-content-between">
				<div class="file-upload d-flex">
					<a href="#"  id="fileUploadBtn" onclick="window.open(this.href, '_blank', 'width=800, height=600'); return false;"><img width="35" src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-image-512.png"></a>
				</div>
